    ...
    <div className="mx-auto max-w-6xl px-6 py-16">
      <div className="text-center max-w-3xl mx-auto">
        ...
        <h1 className="mt-4 font-extrabold text-4xl sm:text-6xl leading-tight">
          We build the <span className="brand-gradient-text">stage</span>.
          <br /> You build the future.
        </h1>
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
        {VALUES.map((v) => (
          <div key={v.title} className="rounded-2xl border border-border bg-card p-8 card-hover">
      ...
      <div className="mt-16 rounded-3xl border border-border bg-gradient-to-br from-violet-50 to-fuchsia-50 dark:from-violet-950/40 dark:to-fuchsia-950/20 p-10">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground leading-relaxed max-w-3xl">
              ...
              curiosity, hustle, and a laptop can ship, compete, and win. We are here to remove
              every friction between a spark of an idea and its arrival in the world.
            </p>
          </div>
        </div>
      </div>
