...
const CTASection = () => {
  return (
    <section className="mx-auto max-w-7xl px-6 py-16">
      <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-violet-50 to-fuchsia-50 dark:from-violet-950/40 dark:to-fuchsia-950/30 p-10 md:p-16">
        ...
        <div className="relative grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-muted-foreground text-lg max-w-lg">
              Whether you are hosting or hacking — HackHub gives you the tools, community, and
              stage to make it real.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row gap-3 md:justify-end">
            <Button asChild className="brand-gradient-bg text-white rounded-full h-12 px-7">
              <Link to="/login/contestant">
                Start as contestant
                <ArrowRight className="w-4 h-4 ml-1.5" />
              </Link>
            </Button>
            <Button asChild variant="outline" className="rounded-full h-12 px-7">
              <Link to="/login/admin">Host a hackathon</Link>
            </Button>
          </div>
        </div>
      </div>
