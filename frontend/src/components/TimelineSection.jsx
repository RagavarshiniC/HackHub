      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-start">
        <div>
          ...
          <p className="mt-4 text-muted-foreground text-lg">
            HackHub compresses months of product work into a single weekend. Here is the
            journey most winners follow.
          </p>
        </div>
          ...
          <div className="space-y-8">
            {TIMELINE.map((t) => (
              <div key={t.step} className="relative">
                ...
                <div className="text-xs font-semibold tracking-widest text-violet-500">
                  STEP {t.step}
                </div>
